...
<html lang="en" class="no-js">
	<head>
		...
		<meta name="description" content="Generador de c&oacute;digo online para desarrollo de p&aacute;ginas web" />
		<meta name="keywords" content="html5, jQuery, template, generador, css3, p&aacute;gina, herramienta web, generar pagina, portfolio, dise&ntilde;o web" />
		<meta name="author" content="Gabriela Paredes Morin&iacute;go" />
		<!-- PopUp -->
	...
	<body>
			...
			<section class="hero">
				...
				<div class="container">
					...
					<div class="row hero-content">
						<div class="col-md-12">
							<h1 class="animated fadeInDown">Generador de c&oacute;digo para p&aacute;ginas web basado en jQuery</h1>
							<a href="generador.php" class="use-btn animated fadeInUp">Usa la Herramienta!</a> <a href="#about" class="learn-btn animated fadeInUp">Leer M&aacute;s <i class="fa fa-arrow-down"></i></a>
						</div>
					</div>
					<!-- PopUp -->
		...
		<section style="display:none;" class="video" id="about">
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<h1><a href="http://www.youtube.com/embed/9No-FiEInLA?autoplay=1&wmode=opaque&fs=1" class="youtube-media"><i class="fa fa-play-circle-o"></i> Ver el Video</a></h1>
					</div>
				</div>
			</div>
		</section>
		...
		<section style="display:none;" class="features-intro">
					...
					<div class="col-md-6 nopadding">
						<div class="features-slider">
								<ul class="slides" id="featuresSlider">
									<li>
										<h1>R&aacute;pido dise&ntilde;o del Front-End</h1>
										<p>Con esta herramienta podr&aacute;s obtener el dise&ntilde;o de tu front-end de forma r&aacute;pida, tan s&oacute;lo eligiendo con un click uno de nuestros dise&ntilde;os predeterminados</p>
									</li>
									<li>
										<h1>F&aacute;cil de usar</h1>
										<p>Esta herramienta les ofrece una interfaz amigable y de f&aacute;cil uso </p>
									</li>
									<li>
										<h1>Uso gratuito</h1>
										<p>Esta herramienta fue hecha para el usuario con un poco de conocimiento en el area de desarrollo web y es de uso gratuito!</p>
									</li>
								</ul>
						</div>
					</div>
		...
		<section style="display:none;" class="features-list" id="features">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-4 feature-1 wp2">
							...
							<div class="feature-content">
								<h1>Responsive</h1>
								<p>Los Templates ofrecidos fueron creados usando HTML5/CSS3 y son responsive.</p>
						...
						<div class="col-md-4 feature-2 wp2 delay-05s">
							...
							<div class="feature-content">
								<h1>Proposito</h1>
								<p>Crear de forma r&aacute;pida una p&aacute;gina web utilizando los lenguajes HTML5, CSS y la libreria jQuery.</p>
							</div>
						</div>
						<div class="col-md-4 feature-3 wp2 delay-1s">
							...
							<div class="feature-content">
								<h1>Absolutamente gratis</h1>
								<p>Es una herramienta online, totalmente gratis, simple y f&aacute;cil de usar.
									 </p>
							</div>
						</div>
		...
		<section style="display:none;" class="showcase">
		...
		<section style="display:none;" class="screenshots-intro">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
		...
		<section style="display:none;" class="download" id="download">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-5">
						...
						<img src="img/logo-red.png" alt="Footer Logo Blue">
						</h1>
						<p>© MakePage 2015 - <a href="http://tympanus.net/codrops/licensing/">Licence</a> - Designed &amp; Developed by <a href="http://www.peterfinlan.com/">Peter Finlan</a></p>
					</div>
					<div class="col-md-7">
						<ul class="footer-nav">

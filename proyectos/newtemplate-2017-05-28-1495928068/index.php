...
<div id="MenuBderecho">
	...
	<menu type="context" id="hnMenu">
	  ...
	  <menuitem label="Propiedades H" id="propiedadesh" icon="../../img/MenuDerecho/propiedades.png"/></menuitem>
	</menu>
...
<div class="popUp" style="display: none;">
        <!-- Confirmar Eliminar -->
        <div id="confirmEliminar" style="font-size: 80%;" title="Confirmar Eliminar">
            <div class="formPopUp">
                Est&aacute; seguro de que desea eliminar este registro?
            </div>
        </div>
    </div>

...
<div id="MenuBderecho">
	...
	<menu type="context" id="hnMenu">
	  ...
	  <menuitem label="Propiedades H" id="propiedadesh" onclick="editarElemento('Editar Eventos H');" icon="../../img/MenuDerecho/propiedades.png"/></menuitem>
	</menu>
...
<div class="popUp" style="display: none;">
  ...
  <div class="col-md-12">
  		<select id='ddlEvento'>
					...
					<option value="mouseout">mouseover()</option>

			  		...
			  		<div class="container-fluid">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									<br>
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Gabriela <span class="caret"></span></a>
									<br>
		...
		<div class="dest col-md-11">
	  		...
	  		<div class="panel-body">
				...
				<div id="div1" class="jumbotron rotator soltarEn ui-droppable">
					<h1 id='h1_1' class="rotator">Hello, world!</h1>
					<p>...</p>

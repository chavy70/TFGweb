    ...
    $.fn.extend({
        rotateit: function(options) {
            return this.each(function() {
                ...
                /*toprightcorner.css('background-image', 'url(../img/tr.png)');
                bottomrightcorner.css('background-image', 'url(../img/br.png)');
                bottomleftcorner.css('background-image', 'url(../img/bl.png)');
                topleftcorner.css('background-image', 'url(../img/tl.png)');*/
                /*resize related */
